...
void create_WLB_BOT(string Name,ENUM_TIMEFRAMES P,
   ...
   string new_name = Name + string(ArraySize(WLB_BOT));
   WLB_BOT[ArraySize(WLB_BOT)-1] = WLB_Analyse(new_name,P,this_pm,WLB_TimeOut,WLB_Bonus,WLB_Percent,WLB_BodyPercent,WLB_BodyBigger,PE_VAL,WLB_mode);                                     
}
