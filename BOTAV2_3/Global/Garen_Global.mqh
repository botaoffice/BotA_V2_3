  ...
  int v=          int(CharToString(char_type[12])); 
      ...
      if(Detail == 0){
         ...
         //for(is_DL=0;is_DL<2;is_DL++){
            call_create(j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,WLB_BOT[i].get_P(),WLB_BOT[i].get_name(),is_DL,Ave_ID,AveTimeTarget,AveMinSpeed);
         }}}//}//}
   ...
   double maxloss=0;
       ...
       //---------------------------------------------------------------------------------------------
                ...
                //   BE      | ProfitMin  | MaxLoss               | MaxLossFactor    |  SL      | TP      |SESSION |AdjustPE    
                     0.1 *q  ,   0.05*r  ,   maxloss/*4.0   + 2.0*n*/,maxlossfactor,    0.15*s    ,  0.25+(0.5*t) , x, y ,    ape);
      //---------------------------------------------------------------------------------------------   
}
